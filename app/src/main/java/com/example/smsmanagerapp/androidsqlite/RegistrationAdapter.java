...
public class RegistrationAdapter {
    ...
    public Cursor queryName() {
        ...
        opnToWrite();
        Cursor c = database_ob.query(openHelper_ob.TABLE_NAME, cols, null, null, null,
                null, null);
        return c;
    }
    ...
    public Cursor queryAll(int nameId) {
        ...
        opnToWrite();
        Cursor c = database_ob.query(openHelper_ob.TABLE_NAME, cols, openHelper_ob.KEY_ID
                + "=" + nameId, null, null, null, null);
        return c;
    }
    ...
    public long updateldetail(int rowId, String fname, String lname) {
        ...
        contentValues.put(openHelper_ob.LNAME, lname);
        opnToWrite();
        long val = database_ob.update(openHelper_ob.TABLE_NAME,
...
// TODO Auto-generated method stub
        opnToWrite();
        int val = database_ob.delete(openHelper_ob.TABLE_NAME, openHelper_ob.KEY_ID + "="
                + rowId, null);
        Close();
        return val;
    }
